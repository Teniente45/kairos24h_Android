...
object BuildURL {
    ...
    const val urlServidor = URL_DEMO_Kairos24h + "r=citaRedWeb/crearFichajeExterno&xGrupo=&xEntidad=1003&cKiosko=&cFicOri=APP" //CAMBIAR POR URL PARA MOSTRAR LOS FICHAJES
